...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _drawing_canvas_drawing_canvas_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_drawing_canvas_drawing_canvas_component__WEBPACK_IMPORTED_MODULE_1__["DrawingCanvasComponent"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _canvas_map_canvas_map_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./canvas-map/canvas-map.component */
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _drawing_canvas_drawing_canvas_component__WEBPACK_IMPORTED_MODULE_4__["DrawingCanvasComponent"], _canvas_map_canvas_map_component__WEBPACK_IMPORTED_MODULE_5__["CanvasMapComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppCanvasMapCanvasMapComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CanvasMapComponent", function () {
      return CanvasMapComponent;
    });
    /* harmony import */
    ...
    var CanvasMapComponent =
    /*#__PURE__*/
    function () {
      function CanvasMapComponent() {
        _classCallCheck(this, CanvasMapComponent);

        this.drawing = false;
        this.points = [];
      }

      _createClass(CanvasMapComponent, [{
        key: "ngOnInit",
        ...
        value: function click(e) {
          ...
          var pointsL = this.points.length;
    ...
    CanvasMapComponent.ɵfac = function CanvasMapComponent_Factory(t) {
      return new (t || CanvasMapComponent)();
    };

    CanvasMapComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: CanvasMapComponent,
      selectors: [["app-canvas-map"]],
      viewQuery: function CanvasMapComponent_Query(rf, ctx) {
        if (rf & 1) {
      ...
      decls: 4,
      vars: 0,
      consts: [["width", "900", "height", "900", 3, "click"], ["canvas", ""]],
      template: function CanvasMapComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CanvasMapComponent_Template_canvas_click_2_listener($event) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CanvasMapComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppDrawingCanvasDrawingCanvasComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var save_svg_as_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! save-svg-as-png */
    "./node_modules/save-svg-as-png/lib/saveSvgAsPng.js");
    /* harmony import */


    var save_svg_as_png__WEBPACK_IMPORTED_MODULE_2___default =
    /*#__PURE__*/
    __webpack_require__.n(save_svg_as_png__WEBPACK_IMPORTED_MODULE_2__);
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function DrawingCanvasComponent(renderer) {
      ...
      _createClass(DrawingCanvasComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.svg = d3__WEBPACK_IMPORTED_MODULE_1__["select"]('.artboard').append('svg').attr('height', 950).attr('width', 1250);
        }
      }, {
        key: "mouseUp",
        value: function mouseUp(e) {
          ...
          var polyline = this.g.append('polyline').attr('points', this.points).style('fill', 'none').attr('stroke', '#000');

          for (var i = 0; i < this.points.length; i++) {
            this.g.append('circle').attr('cx', this.points[i][0]).attr('cy', this.points[i][1]).attr('r', 4).attr('fill', 'yellow').attr('stroke', '#000').attr('is-handle', 'true').attr('style', "cursor:pointer");
          }
        }
      }, {
        key: "closePolygon",
        value: function closePolygon() {
          ...
          g.append('polygon').attr('points', this.points).style('fill', this.color);

          var _loop = function _loop() {
            var holder = _this;
            circle = g.selectAll('circles').data([_this.points[i]]).enter().append('circle').attr('cx', _this.points[i][0]).attr('cy', _this.points[i][1]).attr('r', 4).attr('fill', '#FDBC07').attr('stroke', '#000').attr('is-handle', 'true').attr('cursor', 'move').call(d3__WEBPACK_IMPORTED_MODULE_1__["drag"]().on('drag', function () {
        ...
        value: function mouseMove(e) {
          ...
          var line = g.append('line').attr('x1', this.startPoint[0]).attr('y1', this.startPoint[1]).attr('x2', e.pageX - this.artboard.nativeElement.offsetLeft + 1).attr('y2', e.pageY - this.artboard.nativeElement.offsetTop + 1).attr('stroke', '#53DBF3').attr('stroke-width', 1);
        }
      }, {
        key: "handleDrag",
        ...
        value: function save() {
          ...
          save_svg_as_png__WEBPACK_IMPORTED_MODULE_2__["saveSvgAsPng"](this.artboard.nativeElement.children[0], this.url.nativeElement.value.split('/').pop(), {
            width: 1164,
            height: 874,
            top: 43,
            left: 38
        ...
        key: "changeColor",
        value: function changeColor(id) {
          var colors = ['#402020', '#ff0000', '#808060', '#00ff66', '#cc00ff'];
    ...
    DrawingCanvasComponent.ɵfac = function DrawingCanvasComponent_Factory(t) {
      return new (t || DrawingCanvasComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"]));
    };
    ...
    DrawingCanvasComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function DrawingCanvasComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function DrawingCanvasComponent_Template_input_input_5_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DrawingCanvasComponent_Template_button_click_7_listener() {
            return ctx.changeColor(0);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DrawingCanvasComponent_Template_button_click_9_listener() {
            return ctx.changeColor(1);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DrawingCanvasComponent_Template_button_click_11_listener() {
            return ctx.changeColor(2);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DrawingCanvasComponent_Template_button_click_13_listener() {
            return ctx.changeColor(3);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DrawingCanvasComponent_Template_button_click_15_listener() {
            return ctx.changeColor(4);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function DrawingCanvasComponent_Template_input_input_21_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DrawingCanvasComponent_Template_button_click_23_listener() {
            return ctx.save();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("mouseup", function DrawingCanvasComponent_Template_div_mouseup_25_listener($event) {
            return ctx.mouseUp($event);
          })("mousemove", function DrawingCanvasComponent_Template_div_mousemove_25_listener($event) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Erik\dev\img-labeler\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
